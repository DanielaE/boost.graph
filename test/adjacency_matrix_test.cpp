...
boost::add_edge(boost::vertex(1, g1), boost::vertex(2, g1), g1);
   ...
   BGL_FORALL_EDGES_T(e, g1, Graph1) {
     edge_pairs_g1.push_back(
       std::make_pair(static_cast<int>(get(index_map1, source(e, g1))),
                      static_cast<int>(get(index_map1, target(e, g1)))));
   }
   ...
   BGL_FORALL_EDGES_T(e, g3, Graph2) {
     edge_pairs_g3.push_back(
       std::make_pair(static_cast<int>(get(index_map3, source(e, g3))),
                      static_cast<int>(get(index_map3, target(e, g3)))));
   }
